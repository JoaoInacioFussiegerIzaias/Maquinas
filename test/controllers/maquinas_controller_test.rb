...
class MaquinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maquina" do
    assert_difference("Maquina.count") do
      post maquinas_url, params: { maquina: { modelo: @maquina.modelo, nome: @maquina.nome } }
    end
  ...
  test "should update maquina" do
    patch maquina_url(@maquina), params: { maquina: { modelo: @maquina.modelo, nome: @maquina.nome } }
